    ...
    <div id="MainLayout" class="w-full h-screen">
        <div v-if="$page.url==='/'" id="TopNavHome"
            ...
            <div class="flex items-center justify-between h-full">
                <Link href="/">
                    <img class="w-[105px] ml-6 cursor-pointer" src="/logo/insta-logo.png" alt="">
                </Link>
                <div class="flex item-center w-[50%]">
                    <div class="flex items-center w-full bg-gray-100 rounded-lg">
                        <Magnify class="pl-4" fill-color="#8E" :size="27" />
        ...
        >
            <Link href="/" class="px-4">
                <ChevronLeft :size="38" class="cursor-pointer" />

            </Link>
            <div class="font-extrabold text-lg">The Name</div>
        ...
        <div id="SideNav" class="fixed h-full bg-white xl:w-[280px] w-[80px] md:block hidden border-r border-r-gray-300">
            ...
            <Link href="/">
                <img class="xl:hidden block w-[25px] mt-10 ml-[25px] mb-10 cursor-pointer" src="/logo/insta-logo-small.png">
                <img class="xl:block hidden w-[120px] mt-10 ml-6 mb-10 cursor-pointer" src="/logo/insta-logo.png">
            </Link>
            <div class="px-3">
                <Link href="/">
